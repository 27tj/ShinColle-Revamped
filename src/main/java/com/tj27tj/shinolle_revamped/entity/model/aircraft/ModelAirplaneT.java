...
public class ModelAirplaneT extends EntityModel<Entity> {
	...
	public ModelAirplaneT() {
		...
		Wing02.setRotationPoint(-2.0F, -0.4F, -2.5F);
		...
		Tail03.setRotationPoint(0.0F, -2.2F, 4.5F);
		...
		Prop02.setRotationPoint(0.0F, -1.0F, -7.1F);
		BodyMain.addChild(Prop02);
		Prop02.setTextureOffset(1, 25).addBox(-0.5F, -0.5F, 0.0F, 1.0F, 1.0F, 2.0F, 0.0F, false);

		Wing01 = new ModelRenderer(this);
		Wing01.setRotationPoint(2.0F, -0.4F, -2.5F);
		...
		Tank.setRotationPoint(0.0F, 1.5F, -5.5F);
		BodyMain.addChild(Tank);
		setRotationAngle(Tank, 0.0349F, 0.0F, 0.0F);
		Tank.setTextureOffset(32, 7).addBox(-1.0F, 0.0F, 0.0F, 2.0F, 2.0F, 14.0F, 0.0F, false);
